  ...
  return (
    <section className="pt-1">
                ...
                return (
                  <motion.div
                    ...
                    style={{
                      ...
                      cursor: isFront && count > 1 ? "pointer" : "default",
                    ...
                    /* ⚠️ TODO — با ساخته‌شدنِ /image/[id]: کلیک باید صفحه‌ی خودِ
                       عکس را باز کند. تا آن موقع کلیک ورق می‌زند، که هم کارِ
                       بی‌ربط نمی‌کند و هم لمس روی موبایل را بی‌جواب نمی‌گذارد. */
                    onClick={isFront && count > 1 ? advance : undefined}
                  >
                    <Image
                      src={card.url}
      ...
      <div className="flex justify-center pb-3 pt-[14px]">
        <Link
          href={`${galleryHref({ category: active.slug })}#gallery`}
